// JEE Advanced 2019 Question Manager
const jeeAdvanced2019 = {
    // Paper configuration
    paperConfig: {
        paper1: {
    ...
    savePaper: function() {
        localStorage.setItem('jeeAdvanced2019Paper1', JSON.stringify(this.currentPaper));
    },
    
    // Load paper from localStorage
    loadPaper: function() {
        const savedPaper = localStorage.getItem('jeeAdvanced2019Paper1');
        if (savedPaper) {
