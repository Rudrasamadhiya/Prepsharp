// JEE Advanced 2018 Question Manager
const jeeAdvanced2018 = {
    // Paper configuration
    paperConfig: {
        paper1: {
            ...
            questionTypes: {
                ...
                comprehension: { count: 4, marks: 3, negative: 1 }
            }
        }
    },
    ...
    // Question counters
    questionCounts: {
        physics: { mcq: 0, nat: 0, comprehension: 0 },
        chemistry: { mcq: 0, nat: 0, comprehension: 0 },
        mathematics: { mcq: 0, nat: 0, comprehension: 0 }
    },
    ...
    initPaper: function(paperKey) {
        ...
        this.currentPaper = {
            id: `jee-adv-2018-${paperKey}-${Date.now()}`,
            type: 'jee-advanced',
            name: config.name,
            year: '2018',
    ...
    savePaper: function() {
        localStorage.setItem('jeeAdvanced2018Paper1', JSON.stringify(this.currentPaper));
    },
    
    // Load paper from localStorage
    loadPaper: function() {
        const savedPaper = localStorage.getItem('jeeAdvanced2018Paper1');
        if (savedPaper) {
